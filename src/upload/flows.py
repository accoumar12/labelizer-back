...
import pandas as pd
import src.upload.crud
from fastapi import Depends
from sqlalchemy.orm import Session
from src.config.app_config import app_config
from src.core.database.manage import get_db
from src.items.crud import create_items
from src.items.utils import load_items
from src.triplets.crud import create_triplets, create_validation_triplets
from src.triplets.utils import (
...
def upload_data(file_in_memory: io.BytesIO, db: Session = Depends(get_db)) -> None:
    ...
    src.upload.crud.create_upload_status(db, all_triplets_count)
